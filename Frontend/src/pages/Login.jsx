          ...
          <div className="grid md:grid-cols-2 min-h-[600px]">
            ...
            <div className="p-6 sm:p-8 md:p-12 flex flex-col justify-center">
              <div className="text-center mb-8">
                ...
                <p className="text-sm sm:text-base text-slate-600">Login to your account</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  type="submit"
                  className="w-full py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white font-bold rounded-xl shadow-xl hover:shadow-2xl hover:scale-105 transition-all duration-300"
                >
                  Login
                </button>
              </form>
